...
import com.jzx.bda.somero.dubbomonitor.provider.impl.support.Configuration;
import com.jzx.bda.somero.store.inter.InsertService;

public class SomeroMysqlServiceImpl implements SomeroService {
    ...
    public SomeroMysqlServiceImpl(Configuration c) {
