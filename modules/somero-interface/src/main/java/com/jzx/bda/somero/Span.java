...
public class Span implements Serializable {
	private static final long serialVersionUID = -6038130265232672546L;
	...
	public String toString() {
		return "Span{" + "traceId=" + traceId + ", id=" + id + ", parentId=" + parentId + ", serviceId=" + serviceId + ", spanName='" + spanName + '\'' + ", annotations=" + annotations
				+ ", binaryAnnotations=" + binaryAnnotations + ", isSample=" + isSample + '}';
	}
